...
<body>
    ...
    <form action= "/cgPetSimulator/" method = "post" >
        ...
        if ($petGrade != '')
        {
            ...
            echo '掉档值<input type=text name="petDiffGrade" value="'.$petDiffGrade.'" style=" width:280px" placeholder="">输入类似12223的掉档值,默认为满档<br>';
            echo '随机档<input type=text name="petRandomGrade" value="'.$petRandomGrade.'" style=" width:280px" placeholder="22222">输入类似12223的随机档，可空，默认为22222<br>';
            echo '加点方式<input type=text name="addBP" value="'.$addBP.'" style=" width:280px" placeholder="0,0,0,0,0">按照顺序输入加点，默认不加<br>';
        }
        ?>
